...
import com.account.service.dashboard.GstDashboardService;
...
public class DashboardController {
    ...
    private final GstDashboardService gstDashboardService;
    ...
    @GetMapping("/gst-collected")
    @Operation(
            summary = "Get GST collected summary",
            description = """
                Returns taxable amount, total GST,
                pending GST, filed GST and reconciled GST
                for invoices generated by the selected user.
                """
    )
    public ResponseEntity<GstCollectedSummaryDto>
    getGstCollectedSummary(
        ...
        return ResponseEntity.ok(
                gstDashboardService.getGstCollectedSummary(
                        userId,
                        fromDate,
                        toDate
                )
