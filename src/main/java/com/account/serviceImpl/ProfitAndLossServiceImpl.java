...
import com.account.service.ProfitAndLossService;
...
//        dataList.add(Map.of("title",expenses));
        ...
        if(preTotalRevenue>0) {
        	...
        	preProfitExceptional = preExpenses;
        }
	   ...
	   public Map<String, Double> getAllProfitAndLossForBalanceSheet(String startDate, String endDate) {
...
//	    			List<Voucher> voucher = voucherRepository.findAllByLedgerIdIn(ledgerIds);
	        ...
	        double preProfitExceptional = preTotalRevenue-preExpenses;
	        System.out.println("test......currProfitExceptional "+currProfitExceptional);
	        System.out.println("test......preProfitExceptional "+preProfitExceptional);

	        res.put("Profit before exceptional and extraordinary items and tax curr", currProfitExceptional);
	        res.put("Profit before exceptional and extraordinary items and tax pre", preProfitExceptional);
