    ...
    mapGovernmentFeeVoucherListItem(AccountingVoucher voucher) {
        ...
        if (clientUnitId != null) {
            ...
            List<Contact> contacts =
                    contactRepository
                            .findByCompanyUnitIdAndDeleteStatusFalse(
                                    clientUnitId
                            );
...
// ========================================
                ...
                .clientAddressLine1(
                        clientUnit != null
                                ? clientUnit.getAddressLine1()
                                : null
                )

                .clientAddressLine2(
                        clientUnit != null
                                ? clientUnit.getAddressLine2()
                                : null
                )
                ...
                .clientCountry(
                        clientUnit != null
                                ? clientUnit.getCountry()
                                : null
                )

                .clientPinCode(
                        clientUnit != null
                                ? clientUnit.getPinCode()
                                : null
                )
